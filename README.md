...
>[!IMPORTANT]
> 我直接把 **竹知了** 三个字替换成 **竹大嘴** 了，所以README看的作用不大，请去原仓库看原文档：[原仓库](https://github.com/imsai-sh/zhuzhiliao)
...
主音源是**真实竹大嘴的录音短音频**（`res/origin.mp3`，约 7.2 秒），以 base64 内嵌在 HTML
...
竹大嘴是小时候路边摊上几块钱的玩意儿，会响、会烦人、会被大人没收，现在实物越来越难找了。
...
- 把 <https://zhuzhiliao.imsai.cc> 甩给一个也玩过竹大嘴的人，看他愣两秒
